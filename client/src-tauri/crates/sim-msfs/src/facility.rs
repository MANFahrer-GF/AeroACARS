//! ⚠ `SzenerieDiagnose` liegt HIER und nicht im Adapter, obwohl sie nur
//! dort gesetzt wird: Der Adapter ist `cfg(target_os = "windows")`, und
//! damit sieht ihn auf einem Mac KEIN Compiler — auch kein Test. Am
//! 29.08.2026 haben zwei Fehler in genau diesem Modul zwei rote
//! CI-Runden gekostet, weil lokal alles gruen war.
//!
//! Reine Datenlogik gehoert deshalb in den plattformunabhaengigen Teil.
//! Dort laeuft sie bei jedem `cargo test`, auf jedem Rechner.
